...
In collaboration with the Philmus Lab at Oregon State University.
...
This software addresses the issue of counting bacterial colonies. Currently, there are two widely available methods: manual counting and automated proprietary machines. Manual counting is time-consuming, while proprietary machines are very expensive, costing thousands of dollars. This software will introduce a low-cost and accurate method for counting bacterial colonies, speeding up the time researchers need to complete their work. 
...
+ Biologists face two difficult options:
    ...
    + Invest thousands of dollars in commercial automated systems
    + Rely on manual methods, sacrificing time and productivity
